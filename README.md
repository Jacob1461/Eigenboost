...
eigen <- eigenboost(X = X_train, y = y_train,n_rounds = 10, reflection_every = 3, reflections_type = "eigen", tree_depth = 1)


# Make prediction

eigen_preds <- predict.eigenboost(eigen, X_test, n_tree = 7)

# Evaluate

accuracy <- mean(eigen_preds == y_test)
accuracy
#> [1] 0.9714286
```
